...
define df_actions = {
    "nap"       :   Act(name = _("Nap"),  button_icon = "/gui/interface/sleep.webp", label_name = "nap", hour_start=5, hour_stop=23), 
    "sleep"     :   Act(name = _("Sleep"),  button_icon = "/gui/interface/sleep.webp", label_name = "sleep", hour_start=23, hour_stop=5), 
}
