...
define gui.default_talk_button_icon = "/gui/interface/talk.webp"
...
label talk_menu:
    ...
    $ del talk_choices
    call expression menu_result from _call_expression
    return
